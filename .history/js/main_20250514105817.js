...
document.getElementById('search-button').addEventListener('click', (e) => {
  ...
  searchContent.forEach(product => {
    const title = product.querySelector('.search-title').textContent.toLowerCase();
    const description = product.querySelector('.search-description').textContent.toLowerCase();
